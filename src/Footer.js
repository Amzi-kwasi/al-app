    ...
    return (
        <footer>
            <div className='ft-main-item'>
                <h6 className='ft-title' style={{fontSize:"30px"}}>Asvan-Launcher</h6>
                <p>A global digital website that has great impact in education. Earn trust and flexibility with us as an ASVL  user and partner.</p>
            </div>
        ...
        <section className="ft-legal">
            <ul className="ft-legal-list">
                ...
                <li>&copy; <a id="year">2023</a> Copyright.</li>
            </ul>
