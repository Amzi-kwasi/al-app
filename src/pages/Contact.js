    ...
    return (
     ...
     <div className="topnav" id='mxw_nav'>
      <center>
        ...
        <Link to="/contact"><span className="active" title="Contact"><i className='fa fa-phone'></i>&ensp;Contact</span></Link>
...
<br/>
  ...
  <div className="navbarc" id="myNavbarc">
             ...
             <Link to="/contact"><span  className="fa fa-phone act" title="contact"><br/><small className="smaller">Contact</small></span></Link>
